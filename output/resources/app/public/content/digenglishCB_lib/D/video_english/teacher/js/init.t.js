(function(app_o, comm_o, tsoc_o){
	...
	function _load(){
		return new Promise(function(resolve, reject){
			app_o.importLink('/content/digenglishCB_lib/D/video_english/teacher/import.html').then(
				function(doc){
					...
					if(_isDvlp){
						...
						if(tsoc_o){
							...
							tsoc_o.getStudents(function(arr, isOk){
								...
								if(isOk){
									app_o.init(arr, "어휘", "Lesson1", true, true);
									app_o.start();
							...
							*/
							...
							app_o.init(students, "어휘", "Lesson1", true, true);
							app_o.start();
						}
