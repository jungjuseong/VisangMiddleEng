...
const _brdThick = 2;
const _brdThick_focus = d_video_english_s ? 4 : 2; 
...
class ScriptBox  extends React.Component<IScriptBox> {
	...
	private _draw() {
		...
		if(!this.props.view || (this.props.compDiv !== 'DIALOGUE' && !d_video_english_s)) return;
	...
	public componentDidUpdate(prev: IScriptBox) {
		...
		if(d_video_english_s) this.m_viewScript = true;
		else {
	...
	public render()	{
		...
		if(d_video_english_s) arr.push('student');
