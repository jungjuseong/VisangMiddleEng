...
class StudentContext extends StudentContextBase {
	...
	constructor() {
		...
		this.actions.onStopRecord = () => {
			...
			if(App.isDvlp) {
				_.delay(() => {
					if(this.state.mediaType === 'video') this.notifyVideoRecord('/content/D_word_english/data/LS_L6_U7_L1_10_watch.mp4');
					else this.notifyRecorded('/content/D_word_english/data/LS_L6_U7_L1_SENTENCE_10_watch.mp3');
				}, 300);
			}
		};
