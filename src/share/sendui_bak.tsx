...
@observer
export class SendUI extends React.Component<IToPad> {
	private m_btnH = 0;
	private m_max = 0;
	private m_sy = -1;
	private m_vy = -1;
	...
	public componentWillReceiveProps(nextProps: IToPad) {
		if(this.props.sended) return;
		
		if(nextProps.view && !this.props.view) {
			this.m_state.y = nextProps.originY;
	...
	private _drag = (evt: DraggableEvent, data: DraggableData) => {
		...
		this.m_state.y = my + this.props.originY;
