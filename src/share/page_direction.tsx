...
@observer
export class PageDirection extends React.Component<IPageDirection> {
	@observable private m_on = false;

	constructor(props: IPageDirection) {
		super(props);
	...
	public componentDidUpdate(prev: IPageDirection) {
		if(this.props.view) {
			if(!prev.view) {
