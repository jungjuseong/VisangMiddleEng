	...
	public render() {
		...
		return (
			<div className={this._className}>
				<audio ref={this._refAudioWinner} controls={false} autoPlay={false} src={`${_digenglishCB_lib_}team/winner/winner.mp3`}/>
  ...
  <g overflow="visible">
	...
	<g display={this.props.winner === 'ga' || this.props.winner === 'na' ? '' : 'none'}>
		...
		<g transform="translate(364.55 133.6)" opacity="0">
			...
			<image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/2.png`} height="502" width="569"/>
			</g>
		</g>
		...
		<g transform="translate(332 543.15)" opacity="0">
			...
			<image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/ribbon.png`} height="133" width="631"/>
		</g>
		...
		<g transform="translate(497.1 577.6)" opacity="0">
			<animate attributeName="opacity" dur="5.167s" keyTimes="0;0.064;0.135;0.787;0.852;1" values="0;0;1;1;0;0" fill="freeze"/>
			<image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/winner.png`} height="62" width="294"/>
		</g>
		<animate attributeName="display" fill="freeze" repeatCount="1" dur="5.167s" keyTimes="0;0.064;1" values="none;inline;inline"/>
		</g>
		<g>
		<g transform="translate(497.1 128)" opacity="0">
			<animate attributeName="opacity" dur="5.167s" keyTimes="0;0.064;0.135;0.787;0.852;1" values="0;0;1;1;0;0" fill="freeze"/>
			<image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/crown.png`} height="197" width="301"/>
		</g>
		<animate attributeName="display" fill="freeze" repeatCount="1" dur="5.167s" keyTimes="0;0.064;1" values="none;inline;inline"/>
		</g>
		<g>
		<g transform="translate(531.6 315)" opacity="0">
			...
			<image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/team_${this.props.winner ? this.props.winner : ''}.png`}  height="226" width="231"/>
		</g>
		<animate attributeName="display" fill="freeze" repeatCount="1" dur="5.167s" keyTimes="0;0.064;1" values="none;inline;inline"/>
		</g>
	</g>
	<g display={this.props.winner === 'tie' ? '' : 'none'}>
		...
		<g id="ww" transform="translate(492.1 538.1)" opacity="0">
			<animate attributeName="opacity" dur="4.833s" keyTimes="0;0.069;0.145;0.841;0.91;1" values="0;0;1;1;0;0" fill="freeze"/>
			<image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/tie.png`} height="62" width="133" transform="translate(84.55 -2)"/>
		</g>
		<animate attributeName="display" fill="freeze" repeatCount="1" dur="4.833s" keyTimes="0;0.069;1" values="none;inline;inline"/>
		</g>
		<g>
		<g id=".__EC.__99.__95.__EA.__B4.__80" transform="translate(494.15 245.5)" opacity="0">
			<animate attributeName="opacity" dur="4.833s" keyTimes="0;0.069;0.145;0.841;0.91;1" values="0;0;1;1;0;0" fill="freeze"/>
			<image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/hand.png`} height="245" width="332" transform="translate(-17.45 -6.4)"/>
		</g>
		<animate attributeName="display" fill="freeze" repeatCount="1" dur="4.833s" keyTimes="0;0.069;1" values="none;inline;inline"/>
		</g>
		<g>
		<g id="A" transform="translate(198.5 236.5)" opacity="0">
			<animate attributeName="opacity" dur="4.833s" keyTimes="0;0.069;0.145;0.841;0.91;1" values="0;0;1;1;0;0" fill="freeze"/>
			<image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/team_ga.png`} height="226" width="231"/>
		</g>
		<animate attributeName="display" fill="freeze" repeatCount="1" dur="4.833s" keyTimes="0;0.069;1" values="none;inline;inline"/>
		</g>
		<g>
		<g id="B" transform="translate(855.5 236.5)" opacity="0">
			<animate attributeName="opacity" dur="4.833s" keyTimes="0;0.069;0.145;0.841;0.91;1" values="0;0;1;1;0;0" fill="freeze"/>
			<image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/team_na.png`} height="226" width="231"/>
		</g>
		<animate attributeName="display" fill="freeze" repeatCount="1" dur="4.833s" keyTimes="0;0.069;1" values="none;inline;inline"/>
		</g>
	</g>
      ...
      <g transform="translate(388.55 219.05)">
        <g display="none">
          <g transform="translate(80.55 86.95)" opacity="0">
            ...
            <g opacity="1">
              ...
              <image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/effect1.png`} height="44" width="44"/>
            </g>
          </g>
        ...
        <g display="none">
          <g transform="translate(452.1 22.05)" opacity="0">
            ...
            <g opacity="1">
              ...
              <image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/effect2.png`} height="55" width="55"/>
            </g>
          </g>
        ...
        <g display="none">
          <g transform="translate(-44 107.95)" style={{mixBlendMode: 'screen',}} opacity="0">
            ...
            <image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/effect3.png`} height="23" width="11"/>
          </g>
        ...
        <g display="none">
          <g transform="translate(8.6 181.3)" style={{mixBlendMode: 'screen',}} opacity="0">
            ...
            <image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/effect3.png`} height="23" width="11" transform="matrix(.8 0 0 .8 0 0)"/>
          </g>
        ...
        <g display="none">
          <g transform="translate(502.95 80.8)" style={{mixBlendMode: 'screen',}} opacity="0">
            ...
            <image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/effect3.png`} height="23" width="11" transform="matrix(.559 .573 -.573 .559 13.15 0)"/>
          </g>
        ...
        <g display="none">
          <g transform="translate(506.25 136.05)" style={{mixBlendMode: 'screen',}} opacity="0">
            ...
            <image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/effect6.png`} height="32" width="16"/>
          </g>
        ...
        <g display="none">
          <g transform="translate(33.6 -40)" style={{mixBlendMode: 'screen',}} opacity="0">
            ...
            <animate attributeName="opacity" dur="5.167s" keyTimes="0;0.181;0.303;1" values="1;1;0;0" keySplines=".25 .5 .5 1;.25 .5 .5 1;.1 .1 .9 .9" calcMode="spline" fill="freeze"/>
            <image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/effect7.png`} height="45" width="24"/>
          </g>
          <animate attributeName="display" fill="freeze" repeatCount="1" dur="5.167s" keyTimes="0;0.181;0.813;1" values="none;inline;none;none"/>
        </g>
        <g display="none">
          <g transform="translate(417.8 -11)" style={{mixBlendMode: 'screen',}} opacity="0">
            ...
            <image overflow="visible" xlinkHref={`${_digenglishCB_lib_}team/winner/effect7.png`} height="45" width="24" transform="matrix(.797 .604 -.604 .797 27.2 0)"/>
          </g>
